...
/**
 * {@link ProxyRouteAnalysisStrategy} 单元测试
 *
 * @author xingzilong
 * @date 2021/10/13
 */
...
public class ProxyRouteAnalysisStrategyTest {

    @InjectMocks
    ProxyRouteAnalysisStrategy proxyRouteAnalysisStrategy;
...
//        when(codeFile.getPath()).thenReturn("ttt");
        ...
        proxyRouteAnalysisStrategy.analysis(new File("test"), service);
...
//		});
        ...
        proxyRouteAnalysisStrategy.analysis(codeFile, service);
    ...
    public void analysisFile_firstTest() {
        ProxyRouteAnalysisStrategy analysis = Mockito.spy(ProxyRouteAnalysisStrategy.class);
